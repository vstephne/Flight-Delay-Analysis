...
#API tales in airport name and year and return sirport_key(can  be used to get delay at airport level)
...
def getAirportFlightDetail():  #gets airport key and time key
    ...
    flights =  tuple({'x':i[0]} for i in flights)
    return jsonify({'flights':flights,
                   'airport':airport
                   })
###########################################################################################################
#API tales in airport name and flight number and returns individual delay sum and total delay sum over 4 years
...
#  @app.route("/sumDelayLocation", methods=["GET"])
# def getsumDelayLocation():  
#     flight_key,airport_key,IATA_CODE = flightAirport()
#     print(flight_key,airport_key)
#     conn=add_user()
#     cur = conn.cursor()
...
#API takes in airport name and flight name and returns individual delay sum and total delay sum over 4 years
...
def add_user():
    ...
    database_flight = r"Flight_DW.db"
